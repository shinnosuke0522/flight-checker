# Domain Model Testing Conventions
...
## 1. テストの構成とスタイル (Kotest DescribeSpec)
...
### 2.2 状態の適用 (State Transition / `apply`, `replay`) のテスト
