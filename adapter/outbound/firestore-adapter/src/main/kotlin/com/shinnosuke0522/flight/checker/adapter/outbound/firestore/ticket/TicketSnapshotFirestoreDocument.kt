...
import com.shinnosuke0522.flight.checker.domain.flight.ticket.model.NormalTicket
...
data class TicketSnapshotFirestoreDocument(
    var id: String = "",
    var version: Long = 0L,
    var userId: String = "",
    ...
    companion object {
        fun fromDomain(ticket: Ticket): TicketSnapshotFirestoreDocument {
            return TicketSnapshotFirestoreDocument(
