...
class AeroDataBoxFlightMapperTest : FunSpec({
    ...
    context("正常系: 有効なFlightContractの場合") {
        test("FlightInfoに変換できること") {
            ...
            flightInfo.scheduledDepartureTime shouldBe Instant.parse("2026-05-01T10:00:00Z")
            flightInfo.scheduledArrivalTime shouldBe Instant.parse("2026-05-01T20:00:00Z")
        }
    }
